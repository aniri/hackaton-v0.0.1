				...
				<div class="col-md-12">
					<div class="portlet box blue" id="addBeneficiiForm">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i> Adaugare Sucursale Furnizor - <span class="step-title">
								Pas 1 din 6 </span>
							</div>
						...
						<div class="portlet-body form">
							<form action="#" class="form-horizontal" id="CRM_addSucursaleFurnizorPOST" method="POST" enctype="multipart/form-data">
									...
									<div class="form-body">
										<ul class="nav nav-pills nav-justified steps">
											<li>
												...
												1 </span>
												<span class="desc">
												<i class="fa fa-check"></i> Date Sucursala Furnizor </span>
												</a>
											</li>
											<li>
										...
										<div class="tab-content">
											...
											<div class="tab-pane" id="tab1">
												...
												<div class="form-group">
													<label class="control-label col-md-3">Furnizor<span class="required">	* </span>
													</label>
													<div class="col-md-4">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="dateSucursaleFurnizor_denumire" id="dateSucursaleFurnizor_denumire"/>
													</div>
												</div>
												<div class="form-group">
											...
											<div class="tab-pane" id="tab2">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<select class="form-control select2me" name="adresaSediu_judetSector" id="adresaSediu_judetSector" onClick='updateLocalitati("adresaSediu_judetSector")'>
															<option value="">Alege...</option>															
														</select>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="adresaSediu_apNr" id="adresaSediu_apNr"/>
													</div>
												</div>
											</div>
											...
											<div class="tab-pane" id="tab6">
												...
												<input type="hidden" name="CRM_addSucursaleFurnizor" id="CRM_addSucursaleFurnizor" value="submitted">
											</div>
										</div>
									</div>
