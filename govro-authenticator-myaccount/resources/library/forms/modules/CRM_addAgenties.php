...
$agentie = "Agentie";
$agentieData = $agentie::CRM_loadAll();
				...
				<div class="col-md-12">
					<div class="portlet box blue" id="addBeneficiiForm">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i> Adaugare agentie - <span class="step-title">
								Pas 1 din 7 </span>
							</div>
						...
						<div class="portlet-body form">
							<form action="#" class="form-horizontal" id="CRM_addAgencyPOST" method="POST" enctype="multipart/form-data">
									...
									<div class="form-body">
										<ul class="nav nav-pills nav-justified steps">
											<li>
												...
												1 </span>
												<span class="desc">
												<i class="fa fa-check"></i> Date Agentie </span>
												</a>
											</li>
											<li>
										...
										<div class="tab-content">
											...
											<div class="tab-pane" id="tab1">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<select class="form-control" name="dateAgentie_tip" id="dateAgentie_tip">
															<option value="">Alege...</option>
															<?
															showModuleSettings($agentieSettingsData, 'type');	
															?>														
														</select>
													</div>
												</div>													
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="dateAgentie_numeDenumire" id="dateAgentie_numeDenumire"/>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="dateAgentie_cnpCui" id="dateAgentie_cnpCui"/>
													</div>
												</div>												
											</div>
											...
											<div class="tab-pane" id="tab5">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<select class="form-control" name="administrare_status" id="administrare_status">
															...
															<?
															showModuleSettings($agentieSettingsData, 'status');	
															?>
														</select>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<select class="form-control" name="administrare_contract" id="administrare_contract">
															...
															<?
															showModuleSettings($agentieSettingsData, 'contract');	
															?>
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														...
														<input type="hidden" name="administrare_dataInitiala" id="administrare_dataInitiala" value="">
													</div>
												</div>
											</div>
											...
											<div class="tab-pane" id="tab7">
												...
												<input type="hidden" name="CRM_addAgenties" id="CRM_addAgenties" value="submitted">
											</div>
										</div>
									</div>
