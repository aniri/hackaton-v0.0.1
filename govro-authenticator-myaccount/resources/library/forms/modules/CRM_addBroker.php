				...
				<div class="col-md-12">
					<div class="portlet box blue" id="addBeneficiiForm">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i> Adaugare broker - <span class="step-title">
								Pas 1 din 7 </span>
							</div>
						...
						<div class="portlet-body form">
							<form action="#" class="form-horizontal" id="CRM_addBrokerPOST" method="POST" enctype="multipart/form-data">
									...
									<div class="form-body">
										<ul class="nav nav-pills nav-justified steps">
											<li>
												...
												1 </span>
												<span class="desc">
												<i class="fa fa-check"></i> Date Broker </span>
												</a>
											</li>
											<li>
										...
										<div class="tab-content">
											...
											<div class="tab-pane" id="tab1">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="dateBroker_denumire" id="dateBroker_denumire"/>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="dateBroker_cui" id="dateBroker_cui"/>
													</div>
												</div>																							
											</div>
											...
											<div class="tab-pane" id="tab7">
												...
												<input type="hidden" name="CRM_addBroker" id="CRM_addBroker" value="submitted"/>
											</div>
										</div>
									</div>
