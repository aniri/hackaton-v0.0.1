...
$agentiSettingsData = $agenti::CRM_loadSettings();
				...
				<div class="col-md-12">
					<div class="portlet box blue" id="addBeneficiiForm">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i> Adaugare agent - <span class="step-title">
								Pas 1 din 7 </span>
							</div>
						...
						<div class="portlet-body form">
							<form action="#" class="form-horizontal" id="CRM_addAgentPOST" method="POST" enctype="multipart/form-data">
									...
									<div class="form-body">
										<ul class="nav nav-pills nav-justified steps">
											<li>
												...
												1 </span>
												<span class="desc">
												<i class="fa fa-check"></i> Date Agent </span>
												</a>
											</li>
											<li>
										...
										<div class="tab-content">
											...
											<div class="tab-pane" id="tab1">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<select class="form-control" name="dateAgent_tip" id="dateAgent_tip">
															<option value="">Alege...</option>
															
															<?
															showModuleSettings($agentiSettingsData, 'type');	
															?>
														</select>
													</div>
												</div>													
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="dateAgent_numeDenumire" id="dateAgent_numeDenumire"/>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="dateAgent_cnpCui" id="dateAgent_cnpCui"/>
													</div>
												</div>												
											</div>
											...
											<div class="tab-pane" id="tab5">
												...
												<div class="form-group">
													<label class="control-label col-md-3"> Distribuitor <span class="required">	* </span>
													</label>
													<div class="col-md-4">
														<select class="form-control" name="administrare_distribuitor" id="administrare_distribuitor">
															<option value="">Alege...</option>
															<?foreach ($distribuitorData  as $value){echo "<option value='".$value["distribuitorId"]."'>" . $value["dateDistribuitor_numeDenumire"] . "</option>";}?>														
														</select>
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3"> Recomandator <span class="required">	* </span>
													</label>
													<div class="col-md-4">
														<select class="form-control" name="administrare_recomandator" id="administrare_recomandator">
															<option value="">Alege...</option>
												...
												<div class="form-group">
													<label class="control-label col-md-3"> Tip vanzare <span class="required">	* </span>
													</label>
													<div class="col-md-4">
														<select class="form-control" name="administrare_tipVanzare" id="administrare_tipVanzare">
															<option value="">Alege...</option>
															<?
															showModuleSettings($agentiSettingsData, 'paymentType');	
															?>
														</select>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<select class="form-control" name="administrare_status" id="administrare_status">
															<option value="">Alege...</option>
															<?
															showModuleSettings($agentiSettingsData, 'status');	
															?>															
														</select>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<select class="form-control" name="administrare_contract" id="administrare_contract">
															<option value="">Alege...</option>
															<?
															showModuleSettings($agentiSettingsData, 'contract');	
															?>
												...
												<div class="form-group" id="alteDetalii_roCT">
													...
													<div class="col-md-4">
														<select class="form-control" name="alteDetalii_ro" id="alteDetalii_ro">
															<option value="">Alege...</option>
															<?
															showModuleSettings($agentieSettingsData, 'ro');	
															?>														
														</select>
													</div>
												</div>
											...
											<div class="tab-pane" id="tab7">
												...
												<input type="hidden" name="CRM_addAgent" id="CRM_addAgent" value="submitted">
											</div>
										</div>
									</div>
