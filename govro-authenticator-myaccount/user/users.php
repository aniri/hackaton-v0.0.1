...
$restrictions["selectUsers"] = true;

if ($_GET["delete"] == "true")
{
	deleteUser($_SESSION["userEmail"], $_GET["id"]);
	header("Location: users.php");
	
}
if ($_GET["function"] == "editUserGET")
{
	$restrictions["selectUsers"] = false;
	...
	if ($getUserById["email"] != $_POST["email"]){$queryEditUser[2] = "email = '" . $_POST["email"] . "'";}
	if ($getUserById["phone"] != $_POST["phone"]){$queryEditUser[3] = "phone = '" . $_POST["phone"] . "'";}
	if ($getUserById["userRights"] != $_POST["userRights"]){$queryEditUser[4] = "rights = '" . $_POST["userRights"] . "'";}
	if ($getUserById["active"] != $_POST["active"]){$queryEditUser[5] = "active = '" . $_POST["active"] . "'";}
	...
	updateUser($_SESSION["userEmail"], $_GET["id"], $queryEditUser);
	$userDetails = loadUserDetails($_SESSION["userEmail"]);
	$getUserById = getUserById($_GET["id"]);
	}
...
{
	$addUser = array("who" => $_SESSION["userEmail"], "name" => $_POST["name"], "surname" => $_POST["surname"], "email" => $_POST["email"], "phone" => $_POST["phone"], "password" => $_POST["password"], "profileImage" => $_FILES["profileImage"], "userRights" => $_POST["userRights"], "active" => $_POST["active"]);
	addUser($addUser);
	header("Location: users.php");
}
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			...
			<img src="<? $logoImg = getSettings("crmLogo"); echo $logoImg["value"]; ?>" alt="logo" class="logo-default" style="width:240px"/>
			</a>
				...
				<div class="col-md-12">
					...
					else
					{
						...
						echo '<div class="portlet light">
							<div class="portlet-body">'; 
						include("../resources/library/forms/editUser.php");
						echo '</div></div>';
