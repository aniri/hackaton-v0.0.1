...
if ($_GET["function"] == "editUserTypes")
{
	updateUserRights($_GET["id"], $_GET["data"]);
	header('location: otherSettings.php');
}
if (isset($_POST["addIcon"]))
{
$result = array("alias" => $_POST["alias"], "name" => $_POST["name"], "url" => $_POST["url"]);
insertIcon($result);
}
?>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="portlet light">
					...
					<?
					include ("../resources/library/forms/otherSettings.php");
...
<script src="../../assets/admin/layout/scripts/quick-sidebar.js" type="text/javascript"></script>
<script src="../../assets/admin/layout/scripts/demo.js" type="text/javascript"></script>
<script src="../../assets/admin/pages/scripts/userRightsTable.js"></script>
<script>
